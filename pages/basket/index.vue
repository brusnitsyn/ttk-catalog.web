<template>
  <Container class="flex flex-col">
    <div class="flex flex-row gap-x-4">
                ...
                <div class="flex gap-x-3.5">
                  ...
                  <div class="flex flex-col py-1.5">
                    ...
                    <div class="flex flex-col">
                      ...
                      <el-input-number size="small" @change="handleChange(item)" :min="1" :max="999"
                        v-model="item.qty" />
      ...
      <div v-if="basket.length" class="min-w-[320px] max-w-min">
        <h2 class="text-lg font-semibold font-inter pb-4">Оформление заказа</h2>
