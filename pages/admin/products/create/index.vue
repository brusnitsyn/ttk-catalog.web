<template>
  ...
  <div class="pt-6 px-4">
    <div class="flex justify-between">
      ...
      <div>
        <el-button @click="dialogBrandVisible = !dialogBrandVisible" type="primary" icon="el-icon-plus">
          Производитель</el-button>
        <el-button @click="dialogMachineTypeVisible = !dialogMachineTypeVisible" type="primary" icon="el-icon-plus">Тип
        </el-button>
        <el-button @click="dialogMachineVisible = !dialogMachineVisible" type="primary" icon="el-icon-plus">Техника
        </el-button>
      </div>
    </div>
      ...
      <div class="flex flex-col gap-y-2">
        <div class="grid grid-cols-1 lg:grid-cols-6 gap-y-2 md:gap-x-2">
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <el-select v-model="selectedMachineType" :disabled="!(tempProduct.brandId != null)" filterable
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <el-select v-model="tempProduct.machines" :disabled="!(selectedMachineType != null)" filterable
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <el-input v-model="tempProduct.discountPrice" :disabled="!(tempProduct.categoryId == 1)" type="number"
    ...
    <el-dialog title="Добавить производителя" :visible.sync="dialogBrandVisible" width="30%">
    ...
    <el-dialog title="Добавить тип техники" :visible.sync="dialogMachineTypeVisible" width="30%">
      <el-form label-position="top">
        <el-form-item label="Наименование" prop="name">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="createMachineType"> Добавить </el-button>
      </span>
    </el-dialog>

    <el-dialog title="Добавить технику" :visible.sync="dialogMachineVisible" width="30%">
      <el-form label-position="top">
        <el-form-item label="Наименование" prop="name">
        ...
        <el-form-item label="Тип" prop="type">
          <el-select v-model="machine.typeId" filterable class="w-full" no-data-text="Нет данных"
            no-match-text="Тип техники не найден" placeholder="Выберите тип техники" :disabled="machineTypeForBrand">
            <el-option v-for="item in machineTypeForBrand" :key="item.id" :label="item.name" :value="item.id">
            </el-option>
          </el-select>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    selectBrandChange(brand) {
      // let params = { brand: brand }
      // let data = this.$axios.get('/machines-types', { params })
      // this.machineTypeForBrand = data.data
    }
  },
  mounted() {
