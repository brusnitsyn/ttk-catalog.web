  ...
  <div class="pt-6 px-4">
    <div class="flex justify-between">
      ...
      <div>
        ...
        >
        <el-button
          @click="dialogMachineTypeVisible = !dialogMachineTypeVisible"
          type="primary"
          icon="el-icon-plus"
          >Тип
        </el-button>
        <el-button
          @click="dialogMachineVisible = !dialogMachineVisible"
          type="primary"
          icon="el-icon-plus"
          >Техника
        </el-button>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-2 md:gap-x-2 pb-4">
      <div class="flex flex-col gap-y-2">
        <div class="grid grid-cols-1 lg:grid-cols-6 gap-y-2 md:gap-x-2">
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            >
              <el-option
                v-for="item in machineTypesForBrand"
                :key="item.id"
                :label="item.name"
                :value="item.id"
              >
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <el-select
              ...
              :disabled="!(tempProduct.typeId != null)"
              filterable
              class="w-full"
              multiple
              value-key="id"
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <el-input
              ...
              :disabled="!(tempProduct.categoryId == 3)"
              type="number"
              class="w-full"
      ...
      <div class="bg-white px-3 py-2 rounded-md">
        <div class="flex justify-between items-center">
          ...
          <el-button
            type="text"
            @click="dialogPropertiesShow = !dialogPropertiesShow"
          >
            Добавить свойство
          </el-button>
        </div>
    ...
    >
      <el-form ref="dialogCreateMachine" label-position="top">
        ...
        <el-form-item label="Тип" prop="type">
          ...
          >
            <el-option
              v-for="item in dialogMachineTypesForBrand"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            >
